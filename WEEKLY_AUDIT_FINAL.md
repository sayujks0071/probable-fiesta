...
- Active Positions: 0 across 4 expected strategies
- Risk Status: ✅ SAFE (System Offline)
...
- Process Health: 0 strategy processes detected (Expected 4)
...
3. Strategy Process Discrepancy: 4 expected, 0 running → Critical → Restart Services

🔧 INFRASTRUCTURE IMPROVEMENTS:
1. Restart Kite Bridge Service (Port 5001)
2. Restart Dhan Bridge Service (Port 5002)
3. Restart Strategy Supervisor to launch strategies defined in active_strategies.json
...
- [Critical] Restart Broker Bridges and Strategy Services → SysAdmin/Immediate
- [High] Review Audit Report → Risk Manager/Open
