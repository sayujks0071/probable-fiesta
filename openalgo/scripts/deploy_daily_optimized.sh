...
nohup python3 openalgo/strategies/scripts/gap_fade_strategy.py --symbol BANKNIFTY --api_key $OPENALGO_APIKEY > openalgo/log/strategies/gap_fade_strategy_BANKNIFTY.log 2>&1 &
