...
nohup python3 openalgo/strategies/scripts/mcx_commodity_momentum_strategy.py --symbol GOLDM05FEB26FUT --api_key $OPENALGO_APIKEY > openalgo/log/strategies/mcx_commodity_momentum_strategy_GOLDM05FEB26FUT.log 2>&1 &
