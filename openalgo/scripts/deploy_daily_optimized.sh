...
nohup python3 openalgo/strategies/scripts/advanced_ml_momentum_strategy.py --symbol INFY --api_key $OPENALGO_APIKEY > openalgo/log/strategies/advanced_ml_momentum_strategy_INFY.log 2>&1 &
