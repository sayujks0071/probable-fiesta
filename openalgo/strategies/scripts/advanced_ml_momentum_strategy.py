...
# [Optimization 2026-02-19] Changes: threshold: 0.01 -> 0.008 (Lowered due to Rejection 92.9%)
...
def run_strategy():
    ...
    parser.add_argument('--threshold', type=float, default=0.008, help='ROC Threshold')
