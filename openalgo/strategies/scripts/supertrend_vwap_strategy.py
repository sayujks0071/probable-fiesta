...
# [Optimization 2026-02-15] Changes: adx_threshold: 10.0 -> 5 (Lowered due to Rejection 100.0%), stop_pct: 1.4 -> 1.2 (Tightened due to R:R 0.00)

# [Optimization 2026-02-15] Changes: adx_threshold: 15.0 -> 10 (Lowered due to Rejection 100.0%), stop_pct: 1.6 -> 1.4 (Tightened due to R:R 0.00)

# [Optimization 2026-02-15] Changes: adx_threshold: 20.0 -> 15 (Lowered due to Rejection 100.0%), stop_pct: 1.8 -> 1.6 (Tightened due to R:R 0.00)
...
class SuperTrendVWAPStrategy:
    def __init__(self, symbol, quantity, api_key=None, host=None, ignore_time=False, sector_benchmark='NIFTY BANK', logfile=None, client=None):
        ...
        self.threshold = 150
        self.stop_pct = 1.2
        self.adx_threshold = 5  # Added ADX Filter
        self.adx_period = 14
