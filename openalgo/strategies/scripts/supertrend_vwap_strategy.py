...
# [Optimization 2026-02-09] Changes: adx_threshold: 30.0 -> 32.0 (Tightened due to WR 33.3%), stop_pct: 0.8 -> 0.6 (Tightened due to R:R 0.86)
...
class SuperTrendVWAPStrategy:
    def __init__(self, symbol, quantity, api_key=None, host=None, ignore_time=False, sector_benchmark='NIFTY BANK', logfile=None, client=None):
        ...
        self.threshold = 150
        self.stop_pct = 0.6
        self.adx_threshold = 32.0  # Added ADX Filter
        self.adx_period = 14
