...
class MCXMomentumStrategy:
    def __init__(self, symbol, api_key, host, params):
        ...
        self.rm = RiskManager("MCX_Momentum", "MCX", 100000) if RiskManager else None
    ...
    def check_signals(self):
        ...
        # Exit Logic
            ...
            if self.rm:
                ...
                if stop_hit:
                    logger.warning(f"Risk Manager Exit: {reason}")
                    if pos_qty > 0:
...
def generate_signal(df, client=None, symbol=None, params=None):
    ...
    if symbol_key in _STRAT_CACHE:
        ...
        strat.params = strat_params # Update params if they changed
    else:
        strat = MCXMomentumStrategy(symbol_key, api_key, host, strat_params)
