...
class MCXMomentumStrategy:
    def __init__(self, symbol, api_key, host, params):
        ...
        self.rm = RiskManager(strategy_name="MCXMomentum", exchange="MCX", capital=100000) if RiskManager else None
    ...
    def check_signals(self):
        ...
        if self.rm:
            ...
            if not can_trade and not has_position: # Allow exits even if can_trade is False
