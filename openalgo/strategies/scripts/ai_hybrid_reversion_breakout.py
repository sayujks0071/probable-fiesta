...
# [Optimization 2026-02-02] Changes: rsi_lower: 35.0 -> 40 (Relaxed due to Rejection 83.3%)
...
def run_strategy():
    ...
    parser.add_argument('--rsi_lower', type=float, default=40, help='RSI Lower Threshold')
