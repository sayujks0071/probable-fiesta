...
# [Optimization 2026-01-30] Changes: rsi_lower: 30.0 -> 25.0 (Tightened due to WR 40.0%)
...
def run_strategy():
    ...
    parser.add_argument('--stop_pct', type=float, default=1.0, help='Stop Loss Percentage')
