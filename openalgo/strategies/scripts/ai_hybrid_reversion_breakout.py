...
# [Optimization 2026-02-13] Changes: rsi_lower: 35.0 -> 40.0 (High Rejection 80.0%), rsi_upper: 60.0 -> 55 (High Rejection 80.0%)
import os
import sys
import time
import argparse
...
def run_strategy():
    ...
    parser.add_argument('--rsi_lower', type=float, default=40.0, help='RSI Lower Threshold')
