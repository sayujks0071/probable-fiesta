...
# [Optimization 2026-02-15] Changes: rsi_lower: 25.0 -> 20 (Tightened due to WR 40.0%)

# [Optimization 2026-02-15] Changes: rsi_lower: 30.0 -> 25 (Tightened due to WR 40.0%)

# [Optimization 2026-02-15] Changes: rsi_lower: 35.0 -> 30 (Tightened due to WR 40.0%)
...
def run_strategy():
    ...
    parser.add_argument('--rsi_lower', type=float, default=20, help='RSI Lower Threshold')
