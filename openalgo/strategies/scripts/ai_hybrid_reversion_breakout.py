...
# [Optimization 2026-02-19] Changes: rsi_lower: 30.0 -> 25.0 (Tightened due to WR 22.2%)

# [Optimization 2026-02-19] Changes: rsi_lower: 35.0 -> 30.0 (Tightened due to WR 22.2%)
...
def run_strategy():
    ...
    parser.add_argument('--rsi_lower', type=float, default=25, help='RSI Lower Threshold')
