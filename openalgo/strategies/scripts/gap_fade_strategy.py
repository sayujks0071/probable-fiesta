...
# [Optimization 2026-02-10] Changes: threshold: 0.5 -> 0.45 (Lowered due to Rejection 80.0%)
import sys
import os
import argparse
import logging
...
def main():
    ...
    parser.add_argument("--threshold", type=float, default=0.45, help="Gap Threshold %%")
